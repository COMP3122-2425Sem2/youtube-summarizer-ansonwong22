...
if not (OPENROUTER_API_KEY and OPENROUTER_API_ENDPOINT) and not (GITHUB_API_KEY and GITHUB_API_ENDPOINT):
    st.error("❌ API Key or API Endpoint is missing! Please check your secrets in Streamlit Cloud.")
    st.stop()
